...
ALTER TABLE "archive" ADD COLUMN IF NOT EXISTS "space_id" uuid;
...
ALTER TABLE "archive" ALTER COLUMN "space_id" SET NOT NULL;
ALTER TABLE "archive"
  ADD CONSTRAINT archive_space_id_space_id_fk
  FOREIGN KEY ("space_id") REFERENCES "public"."space"("id") ON DELETE cascade;
CREATE INDEX IF NOT EXISTS archive_space_id_idx ON archive (space_id);
