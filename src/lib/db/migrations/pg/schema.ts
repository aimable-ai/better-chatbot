...
export const chatThread = pgTable(
  ...
  (table) => [
    ...
    foreignKey({
      ...
      name: "chat_thread_space_id_space_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const workflow = pgTable(
  ...
  (table) => [
    index("workflow_space_id_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
    ),
    index("workflow_space_user_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
...
export const agent = pgTable(
  ...
  (table) => [
    index("agent_space_id_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const mcpServer = pgTable(
  ...
  (table) => [
    index("mcp_server_space_id_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
    ),
    index("mcp_server_space_user_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
...
export const spaceInvite = pgTable(
  ...
  (table) => [
    index("space_invite_email_idx").using(
      "btree",
      table.email.asc().nullsLast().op("text_ops"),
    ),
    index("space_invite_space_id_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
...
export const spaceMember = pgTable(
  ...
  (table) => [
    index("space_member_space_id_idx").using(
      "btree",
      table.spaceId.asc().nullsLast().op("uuid_ops"),
    ),
    index("space_member_user_id_idx").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
    ...
    unique("space_member_space_id_user_id_unique").on(
      table.spaceId,
      table.userId,
    ),
  ],
